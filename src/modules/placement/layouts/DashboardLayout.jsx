...
export default function DashboardLayout() {
    ...
    const navItems = [
        ...
        { name: 'Practice', path: '/placement/dashboard/practice', icon: Code },
        { name: 'Assessments', path: '/placement/dashboard/assessments', icon: FileText },
        { name: 'Resources', path: '/placement/dashboard/resources', icon: BookOpen },
        { name: 'Profile', path: '/placement/dashboard/profile', icon: User },
    ];
